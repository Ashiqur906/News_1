...
@section('content')
    ...
    <div class="container mt-2 mb-2">
        <h2 class="dh_2_cat">সকল বিভাগ</h2>
        <div class="row">
    ...
    <div class="container first_2">
      <h2 class="" style="border-bottom: 2px solid #e1e1e1;"></h2>
      ...
      <div class="row">
        <div class="col-8">
          ...
          <amp-img src="img/d11.jpg" layout="responsive" width="16" height="9"></amp-img>
        ...
        <div class="col-4" style="padding-left: 39px;">
