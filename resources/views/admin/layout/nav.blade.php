<!-- Navbar -->
<nav class="main-header navbar navbar-expand" style="background-color: #0a3a9b; color:white;">
  <!-- Left navbar links -->
  <ul class="navbar-nav">
    <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <div class="navbar-search-block">
        <form class="form-inline">
          <div class="input-group input-group-sm" style="width: 25%; margin-left: 1156px;">
